...
public class pengajuan_diterima extends Fragment implements dataLoadPengajuan.view {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.pengajuan_diterima,container,false);
        recyclerView = v.findViewById(R.id.recyclePengajuanditerima);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        loadDataPengajuanPresenter loadDataPengajuanPresenter = new loadDataPengajuanPresenter(this);
        loadDataPengajuanPresenter.loadDataPengajuan("pengajuanDiterima");
        return v;
    }
