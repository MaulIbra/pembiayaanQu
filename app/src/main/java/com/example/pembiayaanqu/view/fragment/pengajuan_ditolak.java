...
public class pengajuan_ditolak extends Fragment implements dataLoadPengajuan.view {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.pengajuan_ditolak,container,false);
        recyclerView = v.findViewById(R.id.recyclePengajuanditolak);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        loadDataPengajuanPresenter loadDataPengajuanPresenter = new loadDataPengajuanPresenter(this);
        loadDataPengajuanPresenter.loadDataPengajuan("pengajuanDitolak");
        return v;
    }
